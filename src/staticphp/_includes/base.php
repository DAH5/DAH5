...
<html lang="en">
    ...
    <body>
        ...
        <div class="footer">
            <div class="container">
                <p class="text">Copyright &copy; <a href="--- metadata.site_author_url ---">--- metadata.site_author ---</a>. StaticPHP is available on <a href="http://github.com/StaticPHP" target="_blank">GitHub</a> and <a href="http://gitlab.com/StaticPHP" target="_blank">GitLab</a>.</p>
                <p class="logo"><a href="/"><img src="/assets/images/logos/dah5-logo-2024-alternate-150x35.png" alt="DAH5 Logo"></a></p>
            </div>
        </div>
    </body>
</html>
