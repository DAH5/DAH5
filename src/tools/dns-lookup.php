...
javascripts:
- /assets/javascript/tool-dns-lookup.min.js
...
<section>
    <div class="container">
        ...
        <form method="POST" id="form" data-apiurl="<?php echo NETWORKTOOLS_URL; ?>">
            ...
            <p><button type="submit" id="btnSubmit" disabled>Submit</button>&nbsp;<a href="<?php echo NETWORKTOOLS_URL; ?>/dns" target="_blank">Alternative Tool</a></p>
        </form>
